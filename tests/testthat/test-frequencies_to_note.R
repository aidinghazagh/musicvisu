describe("frequencies_to_notes()", {
  ...
  it("handles NaN input with a warning", {
    expect_warning(frequencies_to_notes(c(440, NaN, 880)))
  })
  it("handles Inf input with a warning", {
    expect_warning(frequencies_to_notes(c(440, Inf, 880)))
  })
  it("handles NA input with a warning", {
    expect_warning(frequencies_to_notes(c(440, NA, 880)))
  })
  it("returns correct length output", {
    result <- frequencies_to_notes(c(440, 880))
